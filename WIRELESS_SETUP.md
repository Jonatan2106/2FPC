...
✅ **Backend**: Running di `http://192.168.67.1:8080`  
...
📱 Mobile app can connect to http://192.168.67.1:8080/api
```
...
```bash
./run-wireless.ps1 -LaptopIp 192.168.67.1
```
...
**Test backend health:**
```bash
curl http://192.168.67.1:8080/health
```
...
WiFi Network (192.168.100.x)
  └─ HP Android (192.168.100.2)
      └─ Mobile App
          └─ Connects to http://192.168.67.1:8080/api
```
